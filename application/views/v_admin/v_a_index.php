        ...
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                ...
                <div class="ml-auto mt-md-3 mt-lg-0">
                    <span class="opacity-7 text-muted text-26"><i class="icon-user"></i></span>
                </div>
            </div>
        </div>
    </div>
    <div class="card border-right">
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                ...
                <div class="ml-auto mt-md-3 mt-lg-0">
                    <span class="opacity-7 text-muted text-26"><i class="icon-social-facebook"></i></span>
                </div>
            </div>
        </div>
    </div>
    <div class="card border-right">
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                ...
                <div class="ml-auto mt-md-3 mt-lg-0">
                    <span class="opacity-7 text-muted text-26"><i class="icon-phone"></i></span>
                </div>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                ...
                <div class="ml-auto mt-md-3 mt-lg-0">
                    <span class="opacity-7 text-muted text-26"><i class="icon-question"></i></span>
                </div>
            </div>
        </div>
    </div>
